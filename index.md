...
<div class="featured-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2rem;">
    ...
    <div class="obra-card">
        <a href="{{ obra.url | relative_url }}">
            <img src="{{ site.baseurl }}/assets/img/{{ obra.imagen_principal }}" alt="{{ page.title }}" class="img-fluid" style="filter: grayscale(100%); transition: filter 0.5s;" onmouseover="this.style.filter='grayscale(0%)'" onmouseout="this.style.filter='grayscale(100%)'">
        </a>
